...
int main(){
	...
	RAM[ 0x4] = 0x2f;          RAM[ 0x5] = 0x01;      //RAM[ 0x4]: 2f01 LOAD f 01
    	RAM[ 0x6] = 0x24;          RAM[ 0x7] = 0x01;      //RAM[ 0x6]: 2401 LOAD 4 01
   	RAM[ 0x8] = 0xb1;          RAM[ 0x9] = 0x10;      //RAM[ 0x8]: b11a JUMP 1 1a
    	RAM[ 0xa] = 0x51;          RAM[ 0xb] = 0x1f;      //RAM[ 0xa]: 511f ADD  1 1f
	RAM[ 0xc] = 0x54;          RAM[ 0xd] = 0x41;      //RAM[ 0xc]: 544f ADD  4 41
	RAM[ 0xe] = 0xb0;          RAM[ 0xf] = 0x08;      //RAM[ 0xe]: b008 JUMP 0 08
	RAM[0x10] = 0xc0;          RAM[0x11] = 0x00;      //RAM[0x10]: c000 HALT 0 00 
	//END 0 0
