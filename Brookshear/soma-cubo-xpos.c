...
int main(){
	...
	RAM[ 0x4] = 0x24;        	RAM[ 0x5] = 0x01;      	//RAM[ 0x6]: 2401 LOAD 4 01
	RAM[ 0x6] = 0x2e;        	RAM[ 0x7] = aa;      	//RAM[ 0x8]: 2e05 LOAD e 05
	RAM[ 0x8] = 0x2f;        	RAM[ 0x9] = 0x01;      	//RAM[ 0xa]: 2f01 LOAD f 01
    	RAM[ 0xa] = 0x22;           	RAM[ 0xb] = 0x01;       //RAM[ 0x4]: 2201 LOAD 2 01
    	RAM[ 0xc] = 0x25;           	RAM[ 0xd] = 0x01;       //RAM[ 0x4]: 2501 LOAD 5 01
	RAM[ 0xe] = 0xb1;        	RAM[ 0xf] = 0x30;      	//RAM[ 0xc]: b12e JUMP 1 30
    	RAM[0x10] = 0x51;           	RAM[0x11] = 0x1f;       //RAM[ 0xe]: 511f ADD 1 1f
    	RAM[0x12] = 0x40;           	RAM[0x13] = 0x13;       //RAM[0x10]: 4013 MOVE 0 13
    	RAM[0x14] = 0x40;           	RAM[0x15] = 0x10;       //RAM[0x12]: 4010 MOVE 0 10
    	RAM[0x16] = 0x53;           	RAM[0x17] = 0x31;       //RAM[0x14]: 5331 ADD 3 31
     	RAM[0x18] = 0x52;           	RAM[0x19] = 0x2f;       //RAM[0x16]: 522f ADD 2 2f
    	RAM[0x1a] = 0xb2;           	RAM[0x1b] = 0x1e;    	//RAM[0x18]: b21e JUMP 2 1e
    	RAM[0x1c] = 0xb0;           	RAM[0x1d] = 0x16;       //RAM[0x1a]: b016 JUMP 0 16
    	RAM[0x1e] = 0x40;           	RAM[0x1f] = 0x35;       //RAM[0x10]: 4035 MOVE 0 35
    	RAM[0x20] = 0x22;           	RAM[0x21] = 0x01;       //RAM[ 0x4]: 2201 LOAD 2 01
    	RAM[0x22] = 0x53;           	RAM[0x23] = 0x35;       //RAM[0x14]: 5335 ADD 3 35
    	RAM[0x24] = 0x52;           	RAM[0x25] = 0x2f;       //RAM[0x16]: 522f ADD 2 2f
    	RAM[0x26] = 0xb2;           	RAM[0x27] = 0x2a;       //RAM[0x18]: b22a JUMP 2 2a
    	RAM[0x28] = 0xb0;           	RAM[0x29] = 0x22;       //RAM[0x1a]: b022 JUMP 0 22
    	RAM[0x2a] = 0x40;           	RAM[0x2b] = 0xe0;       //RAM[0x1c]: 40e0 MOVE 0 e0
    	RAM[0x2c] = 0x54;           	RAM[0x2d] = 0x43;       //RAM[0x1e]: 5443 ADD 4 43
    	RAM[0x2e] = 0xb0;           	RAM[0x2f] = 0x0a;       //RAM[0x1a]: b00a JUMP 0 0a
    	RAM[0x30] = 0xc0;           	RAM[0x31] = 0x00;      	//RAM[0x20]: c000 HALT 0 00
	//END 0 0
