...
int main(){
    ...
    RAM[0x14] = 0x000b000f;           RAM[0x15] = 0x00000028;       //JUMP
    ...
    RAM[0x24] = 0x00050006;           RAM[0x25] = 0x00060004;       //ADD
    RAM[0x26] = 0x000b0000;           RAM[0x27] = 0x00000012;       //JUMP
    RAM[0x28] = 0x00040000;           RAM[0x29] = 0x00060004;       //MOVE
    RAM[0x2a] = 0x000c0000;           RAM[0x2b] = 0x00000000;       //RAM[0x1a]: HALT  00 00   // END
