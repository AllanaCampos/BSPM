...
void fact(uint64_t a){
    ...
    RAM[ 0x0] = 0x00000002000000fa;           RAM[ 0x1] = 0x0000000000000004;       //RAM[ 0x0]: 2a02 LOAD  0a 02 //2
    RAM[ 0x2] = 0x00000002000000fb;           RAM[ 0x3] = 0xfffffffffffffffc;       //RAM[ 0x2]: 2bfe LOAD  0b fe //-2
    RAM[ 0x4] = 0x00000002000000fe;           RAM[ 0x5] = 0x000000000000fc07;       //RAM[ 0x4]: 29aa LOAD  09 aa //base
    RAM[ 0x6] = 0x00000002000000f1;           RAM[ 0x7] = 0x000000000000fc08;       //RAM[ 0x4]: 29aa LOAD  09 aa //base
    RAM[ 0x8] = 0x00000002000000ff;           RAM[ 0x9] = 0x000000000000fc09;       //RAM[ 0x6]: 2ddc LOAD  0d dc //topo
    RAM[ 0xa] = 0x000000020000000f;           RAM[ 0xb] = a;                //RAM[ 0x8]: 2f02 LOAD  0f 02 //Parametros
    RAM[ 0xc] = 0x000000020000000e;           RAM[ 0xd] = 0x0000000000000001;       //RAM[ 0xa]: 2e07 LOAD  0e 07 //Parametros
    RAM[ 0xe] = 0x0000000200000000;           RAM[ 0xf] = 0x0000000000000016;       //RAM[0x4c]: 2054 LOAD  00 54 // REG[0x00] <- 54
    RAM[0x10] = 0x0000000300000000;           RAM[0x11] = 0x000000000000fc05;       //RAM[0x4e]: 30a7 STORE 00 a7 // RAM[0xa7] <- REG[0x00]
    RAM[0x12] = 0x00000002000000fd;           RAM[0x13] = 0x0000000000000018;       //RAM[0x50]: 29a1 LOAD 09 a1 // RAM[0xa1] <- REG[0x09]
    RAM[0x14] = 0x0000000b00000000;           RAM[0x15] = 0x000000000000fbec;       //RAM[0x52]: b0a0 JUMP  00 a0 // if (REG[0x00] == REG[0x00]) {p <- 0xa0;}
    RAM[0x16] = 0x0000000b00000000;           RAM[0x17] = 0x000000000000eece;       //RAM[0x58]: b05a JUMP  00 5a // GEQ
    RAM[0x18] = 0x0000000200000000;           RAM[0x19] = 0x0000000000000001;       //RAM[ 0xa]: 2e07 LOAD  0e 07 //Parametros
    RAM[0x1a] = 0x0000000b00000004;           RAM[0x1b] = 0x0000000000000038;       //RAM[0x1a]: b088 JUMP  00 88 //00
    RAM[0x1c] = 0x0000000200000001;           RAM[0x1d] = 0x0000000000000002;       //RAM[ 0xa]: 2e07 LOAD  0e 07 //Parametros
    RAM[0x1e] = 0x0000000200000002;           RAM[0x1f] = 0x0000000000000000;       //RAM[ 0xa]: 2e07 LOAD  0e 07 //Parametros
    RAM[0x20] = 0x0000000200000003;           RAM[0x21] = 0x0000000000000001;       //RAM[ 0xa]: 2e07 LOAD  0e 07 //Parametros
    //01
    RAM[0x22] = 0x0000000500000009;           RAM[0x23] = 0x0000000200000003;       //RAM[ 0xc]: 2c1c LOAD  0c 16 
    RAM[0x24] = 0x0000000400000000;           RAM[0x25] = 0x000000010000000e;
    RAM[0x26] = 0x0000000200000000;           RAM[0x27] = 0x000000000000002e;       //RAM[0x4c]: 2054 LOAD  00 54 // REG[0x00] <- 54
    RAM[0x28] = 0x0000000300000000;           RAM[0x29] = 0x000000000000fc05;       //RAM[0x4e]: 30a7 STORE 00 a7 // RAM[0xa7] <- REG[0x00]
    RAM[0x2a] = 0x00000002000000fd;           RAM[0x2b] = 0x0000000000000030;       //RAM[0x50]: 29a1 LOAD 09 a1 // RAM[0xa1] <- REG[0x09]
    RAM[0x2c] = 0x0000000b00000000;           RAM[0x2d] = 0x000000000000fbec;       //RAM[0x52]: b0a0 JUMP  00 a0 // if (REG[0x00] == REG[0x00]) {p <- 0xa0;}
    RAM[0x2e] = 0x0000000b00000000;           RAM[0x2f] = 0x000000000000eece;       //RAM[0x58]: b05a JUMP  00 5a // GEQ
    RAM[0x30] = 0x0000000200000000;           RAM[0x31] = 0x0000000000000000;       //RAM[ 0xa]: 2e07 LOAD  0e 07 //Parametros
    RAM[0x32] = 0x0000000b00000004;           RAM[0x33] = 0x000000000000003c;       //RAM[0x1a]: b088 JUMP  00 88 //02
    RAM[0x34] = 0x0000000400000000;           RAM[0x35] = 0x0000000900000004;
    RAM[0x36] = 0x0000000c00000000;           RAM[0x37] = 0x0000000000000000;       //RAM[0x1c]: c000 HALT  00 00
    RAM[0x38] = 0x0000000400000000;           RAM[0x39] = 0x0000000f00000004;       //RAM[ 0xc]: 2c1c LOAD  0c 16 //00
    RAM[0x3a] = 0x0000000c00000000;           RAM[0x3b] = 0x0000000000000000;       //RAM[0x1c]: c000 HALT  00 00
    RAM[0x3c] = 0x0000000400000000;           RAM[0x3d] = 0x0000000300000002;       //02
    RAM[0x3e] = 0x0000000400000000;           RAM[0x3f] = 0x0000000900000003;
    RAM[0x40] = 0x0000000200000009;           RAM[0x41] = 0x0000000000000001;       //RAM[ 0xe]: 2016 LOAD  00 14
    RAM[0x42] = 0x0000000500000001;           RAM[0x43] = 0x0000000100000009;
    RAM[0x44] = 0x0000000b00000000;           RAM[0x45] = 0x0000000000000022;       //RAM[0x1a]: b088 JUMP  00 88 //01
