...
void fact(uint64_t a){
    ...
    RAM[0x2c] = 0x0000000b00000004;           RAM[0x2d] = 0x0000000000000038;       //RAM[0xeea0]: JUMP  04 38    // if (REG[0x00] == REG[0x04]) {p <- 0x38;}
    RAM[0x2e] = 0x0000000100000009;           RAM[0x2f] = 0x00000000000000f4;       //RAM[0xeea2]: LOAD  09 f4    // REG[0x09] <- RAM[0xf4]
    RAM[0x30] = 0x0000000400000000;           RAM[0x31] = 0x0000000f00000004;       //RAM[0xeea4]: MOVE  00 f4    // REG[0x04] <- REG[0x0f]
    RAM[0x32] = 0x0000000500000004;           RAM[0x33] = 0x0000000400000009;       //RAM[0xeea6]: ADD   04 49    // REG[0x04] <- REG[0x04] + REG[0x09] 
    RAM[0x34] = 0x0000000300000004;           RAM[0x35] = 0x00000000000000f4;       //RAM[0xeea8]: STORE 04 f4    // RAM[0xf4] <- REG[0x04]
    RAM[0x36] = 0x0000000b00000000;           RAM[0x37] = 0x000000000000fbd2;       //RAM[0xeeaa]: JUMP  00 fbd2  // if (REG[0x00] == REG[0x00]) {p <- 0xfbd2;}
    RAM[0x38] = 0x000000050000000f;           RAM[0x39] = 0x0000000f00000001;       //RAM[0xeeac]: ADD   0f f1    // REG[0x0f] <- REG[0x0f] + REG[0x01] 
    RAM[0x3a] = 0x0000000200000000;           RAM[0x3b] = 0x0000000000000042;       //RAM[0xeeae]: LOAD  00 42    // REG[0x00] <- 42
    RAM[0x3c] = 0x0000000300000000;           RAM[0x3d] = 0x000000000000fc07;       //RAM[0xeeb0]: STORE 00 fc07  // RAM[0xfc07] <- REG[0x00]
    RAM[0x3e] = 0x00000002000000fd;           RAM[0x3f] = 0x0000000000000044;       //RAM[0xeeb2]: LOAD  fd 44    // REG[0xfd] <- 44
    RAM[0x40] = 0x0000000b00000000;           RAM[0x41] = 0x000000000000fbea;       //RAM[0xeeb4]: JUMP  00 fbea  // if (REG[0x00] == REG[0x00]) {p <- 0xfbea;}
    RAM[0x42] = 0x0000000b00000000;           RAM[0x43] = 0x000000000000001c;       //RAM[0xeeb6]: JUMP  00 1c    // if (REG[0x00] == REG[0x00]) {p <- 0xee90;} // FIBONACCI
    RAM[0x44] = 0x000000050000000f;           RAM[0x45] = 0x0000000f00000001;       //RAM[0xeeb8]: ADD   0f f1    // REG[0x0f] <- REG[0x0f] + REG[0x01] 
    RAM[0x46] = 0x0000000200000000;           RAM[0x47] = 0x000000000000004e;       //RAM[0xeeba]: LOAD  00 4c    // REG[0x00] <- 4c
    RAM[0x48] = 0x0000000300000000;           RAM[0x49] = 0x000000000000fc07;
    RAM[0x4a] = 0x00000002000000fd;           RAM[0x4b] = 0x0000000000000050;       //RAM[0xeebe]: LOAD  fd 4e    // REG[0xfd] <- 4e
    RAM[0x4c] = 0x0000000b00000000;           RAM[0x4d] = 0x000000000000fbea;       //RAM[0xeec0]: JUMP  00 fbea  // if (REG[0x00] == REG[0x00]) {p <- 0xfbea;}
    RAM[0x4e] = 0x0000000b00000000;           RAM[0x4f] = 0x000000000000001c;       //RAM[0xeec2]: JUMP  00 1c    // if (REG[0x00] == REG[0x00]) {p <- 0xee90;} //  FIBONACCI
    RAM[0x50] = 0x0000000100000009;           RAM[0x51] = 0x00000000000000f4;       //RAM[0xeec4]: LOAD  09 f4    // REG[0x09] <- RAM[0xf4]
    RAM[0x52] = 0x0000000400000000;           RAM[0x53] = 0x0000000900000004;       //RAM[0xeec6]: MOVE  00 94    // REG[0x04] <- REG[0x09] 
    RAM[0x54] = 0x0000000b00000000;           RAM[0x55] = 0x000000000000fbd2;       //RAM[0xeec8]: JUMP  00 fbd2  // if (REG[0x00] == REG[0x00]) {p <- 0xfbd2;} // RET
