...
int main(){
    ...
    RAM[ 0xe] = 0x0000000400000000;           RAM[ 0xf] = 0x0000000f00000004;       //MOVE
    RAM[0x10] = 0x0000000200000005;           RAM[0x11] = 0xffffffffffffffff;       //LOAD
    RAM[0x12] = 0x0000000200000000;           RAM[0x13] = 0x0000000000000001;       //RAM[ 0xe]: LOAD  0e 01   // REG[0x0e] <- 0x0001 // Parametros
    RAM[0x14] = 0x0000000b0000000f;           RAM[0x15] = 0x0000000000000026;       //JUMP
    RAM[0x16] = 0x000000050000000f;           RAM[0x17] = 0x0000000f00000005;       //ADD
    RAM[0x18] = 0x0000000400000000;           RAM[0x19] = 0x000000040000000e;       //MOVE
    RAM[0x1a] = 0x0000000200000000;           RAM[0x1b] = 0x0000000000000022;       //RAM[0xee94]: LOAD  00 28    // REG[0x00] <- 28
    RAM[0x1c] = 0x0000000300000000;           RAM[0x1d] = 0x000000000000fc07;       //RAM[0xee96]: STORE 00 fc07  // RAM[0xfc07] <- REG[0x00]
    RAM[0x1e] = 0x00000002000000fd;           RAM[0x1f] = 0x0000000000000024;       //RAM[0xee98]: LOAD  fd 2a    // REG[0xfd] <- 2a
    RAM[0x20] = 0x0000000b00000000;           RAM[0x21] = 0x000000000000fbea;       //RAM[0xee9a]: JUMP  00 fbea  // if (REG[0x00] == REG[0x00]) {p <- 0xfbea;} // LIT
    RAM[0x22] = 0x0000000b00000000;           RAM[0x23] = 0x000000000000ef8e;       //RAM[0xee9c]: JUMP  00 ef8e  // if (REG[0x00] == REG[0x00]) {p <- 0xef8e;} // MULT
    RAM[0x24] = 0x0000000b00000000;           RAM[0x25] = 0x0000000000000012;       //JUMP
    RAM[0x26] = 0x0000000c00000000;           RAM[0x27] = 0x0000000000000000;       //RAM[0x1a]: HALT  00 00   // END
