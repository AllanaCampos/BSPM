...
int main(){
    ...
    RAM[ 0xc] = 0x0002000f;           RAM[ 0xd] = a;                //RAM[ 0xc]: LOAD  0f a    // REG[0x0f] <- a      // Parametros
    ...
    //FATORIAL
    RAM[0x1c] = 0x00020001;           RAM[0x1d] = 0xffffffff;       //RAM[0xee90]: LOAD  01 -1    // REG[0x01] <- -1
    RAM[0x1e] = 0x0002000e;           RAM[0x1f] = 0x00000001;       //RAM[0xee92]: LOAD  0e 01    // REG[0x0e] <- 01
    RAM[0x20] = 0x00020000;           RAM[0x21] = 0x00000028;       //RAM[0xee94]: LOAD  00 28    // REG[0x00] <- 28
    RAM[0x22] = 0x00030000;           RAM[0x23] = 0x0000fc07;       //RAM[0xee96]: STORE 00 fc07  // RAM[0xfc07] <- REG[0x00]
    RAM[0x24] = 0x000200fd;           RAM[0x25] = 0x0000002a;       //RAM[0xee98]: LOAD  fd 2a    // REG[0xfd] <- 2a
    RAM[0x26] = 0x000b0000;           RAM[0x27] = 0x0000fbea;       //RAM[0xee9a]: JUMP  00 fbea  // if (REG[0x00] == REG[0x00]) {p <- 0xfbea;} // LIT
    RAM[0x28] = 0x000b0000;           RAM[0x29] = 0x0000eece;       //RAM[0xee9c]: JUMP  00 eece  // if (REG[0x00] == REG[0x00]) {p <- 0xeece;} // GEQ
    RAM[0x2a] = 0x00020000;           RAM[0x2b] = 0x00000000;       //RAM[0xee9e]: LOAD  00 00    // REG[0x00] <- 00
    RAM[0x2c] = 0x000b0004;           RAM[0x2d] = 0x00000032;       //RAM[0xeea0]: JUMP  04 38    // if (REG[0x00] == REG[0x04]) {p <- 0x38;}
    RAM[0x2e] = 0x00020004;           RAM[0x2f] = 0x00000001;       //RAM[0xeea2]: LOAD  04 01    // REG[0x04] <- 01
    RAM[0x30] = 0x000b0000;           RAM[0x31] = 0x0000fbd2;       //RAM[0xeeaa]: JUMP  00 fbd2  // if (REG[0x00] == REG[0x00]) {p <- 0xfbd2;}
    RAM[0x32] = 0x0005000f;           RAM[0x33] = 0x000f0001;       //RAM[0xeeac]: ADD   0f f1    // REG[0x0f] <- REG[0x0f] + REG[0x01] 
    RAM[0x34] = 0x00020000;           RAM[0x35] = 0x0000003c;       //RAM[0xeeae]: LOAD  00 3c    // REG[0x00] <- 3c
    RAM[0x36] = 0x00030000;           RAM[0x37] = 0x0000fc07;       //RAM[0xeeb0]: STORE 00 fc07  // RAM[0xfc07] <- REG[0x00]
    RAM[0x38] = 0x000200fd;           RAM[0x39] = 0x0000003e;       //RAM[0xeeb2]: LOAD  fd 3e    // REG[0xfd] <- 3e
    RAM[0x3a] = 0x000b0000;           RAM[0x3b] = 0x0000fbea;       //RAM[0xeeb4]: JUMP  00 fbea  // if (REG[0x00] == REG[0x00]) {p <- 0xfbea;} // LIT
    RAM[0x3c] = 0x000b0000;           RAM[0x3d] = 0x0000001c;       //RAM[0xeeb6]: JUMP  00 1c    // if (REG[0x00] == REG[0x00]) {p <- 0xee90;} // FATORIAL
    RAM[0x3e] = 0x00040000;           RAM[0x3f] = 0x0004000e;       //RAM[0xeeb8]: MOVE  00 4e    // REG[0x0e] <- REG[0x04] 
    RAM[0x40] = 0x00020003;           RAM[0x41] = 0x00000001;       //RAM[0xeeb8]: LOAD  03 01    // REG[0x03] <- 01
    RAM[0x42] = 0x0005000f;           RAM[0x43] = 0x000f0003;       //RAM[0xeeb8]: ADD   0f f3    // REG[0x0f] <- REG[0x0f] + REG[0x03] 
    RAM[0x44] = 0x00020000;           RAM[0x45] = 0x0000004c;       //RAM[0xeeba]: LOAD  00 4c    // REG[0x00] <- 4c
    RAM[0x46] = 0x00030000;           RAM[0x47] = 0x0000fc07;
    RAM[0x48] = 0x000200fd;           RAM[0x49] = 0x0000004e;       //RAM[0xeebe]: LOAD  fd 4e    // REG[0xfd] <- 4e
    RAM[0x4a] = 0x000b0000;           RAM[0x4b] = 0x0000fbea;       //RAM[0xeec0]: JUMP  00 fbea  // if (REG[0x00] == REG[0x00]) {p <- 0xfbea;} // LIT
    RAM[0x4c] = 0x000b0000;           RAM[0x4d] = 0x0000ef8e;       //RAM[0xeec2]: JUMP  00 1c    // if (REG[0x00] == REG[0x00]) {p <- 0xef8e;} // MULT
    RAM[0x4e] = 0x000b0000;           RAM[0x4f] = 0x0000fbd2;       //RAM[0xeec8]: JUMP  00 fbd2  // if (REG[0x00] == REG[0x00]) {p <- 0xfbd2;} // RET

    //GEQ
    RAM[0xeece] = 0x00020000;           RAM[0xeecf] = 0x0000eed6;       //RAM[0xeece]: LOAD  00 eed6 // REG[0x00] <- eed6
    RAM[0xeed0] = 0x00030000;           RAM[0xeed1] = 0x0000fc07;       //RAM[0xeed0]: STORE 00 fc07 // RAM[0xfc07] <- REG[0x00]
    RAM[0xeed2] = 0x000200fd;           RAM[0xeed3] = 0x0000eed8;       //RAM[0xeed2]: LOAD  fd eed8 // REG[0xfd] <- eed8
    RAM[0xeed4] = 0x000b0000;           RAM[0xeed5] = 0x0000fbea;       //RAM[0xeed4]: JUMP  00 fbea // if (REG[0x00] == REG[0x00]) {p <- 0xfbea;}
    RAM[0xeed6] = 0x000b0000;           RAM[0xeed7] = 0x0000efd8;       //RAM[0xeed6]: JUMP  00 efd8 // if (REG[0x00] == REG[0x00]) {p <- 0xefd8;} // GTR
    RAM[0xeed8] = 0x00020000;           RAM[0xeed9] = 0x00000001;       //RAM[0xeed8]: LOAD  00 01   // REG[0x00] <- 01
    RAM[0xeeda] = 0x000b0004;           RAM[0xeedb] = 0x0000eeee;       //RAM[0xeeda]: JUMP  04 eeee // if (REG[0x00] == REG[0x04]) {p <- 0xeeee;}
    RAM[0xeedc] = 0x00020000;           RAM[0xeedd] = 0x0000eee4;       //RAM[0xeedc]: LOAD  00 eee4 // REG[0x00] <- eee4
    RAM[0xeede] = 0x00030000;           RAM[0xeedf] = 0x0000fc07;       //RAM[0xeede]: STORE 00 fc07 // RAM[0xfc07] <- REG[0x00]
    RAM[0xeee0] = 0x000200fd;           RAM[0xeee1] = 0x0000eee6;       //RAM[0xeee0]: LOAD  fd eee6 // RAM[0xfd] <- REG[0xeee6]
    RAM[0xeee2] = 0x000b0000;           RAM[0xeee3] = 0x0000fbea;       //RAM[0xeee2]: JUMP  00 fbea // if (REG[0x00] == REG[0x00]) {p <- 0xfbea;}
    RAM[0xeee4] = 0x000b0000;           RAM[0xeee5] = 0x0000ef70;       //RAM[0xeee4]: JUMP  00 ef70 // if (REG[0x00] == REG[0x00]) {p <- 0xef70;} // EQL
    RAM[0xeee6] = 0x00020000;           RAM[0xeee7] = 0x00000001;       //RAM[0xeee6]: LOAD  00 01   // REG[0x00] <- 01
    RAM[0xeee8] = 0x000b0004;           RAM[0xeee9] = 0x0000eeee;       //RAM[0xeee8]: JUMP  04 eeee // if (REG[0x00] == REG[0x04]) {p <- 0xeeee;}
    RAM[0xeeea] = 0x00020004;           RAM[0xeeeb] = 0x00000000;       //RAM[0xeeea]: LOAD  04 00   // REG[0x04] <- 00
    RAM[0xeeec] = 0x000b0000;           RAM[0xeeed] = 0x0000fbd2;       //RAM[0xeeec]: JUMP  00 fbd2 // if (REG[0x00] == REG[0x00]) {p <- 0xfbd2;}
    RAM[0xeeee] = 0x00020004;           RAM[0xeeef] = 0x00000001;       //RAM[0xeeee]: LOAD  04 01   // REG[0x04] <- 01
    RAM[0xeef0] = 0x000b0000;           RAM[0xeef1] = 0x0000fbd2;       //RAM[0xeef0]: JUMP  00 fbd2 // if (REG[0x00] == REG[0x00]) {p <- 0xfbd2;}
    ...
    RAM[0xfd11] = 0x000b0000;
    RAM[0xfd16] = 0x000b0000;
    RAM[0xfd1b] = 0x000b0000;
    RAM[0xfd20] = 0x000b0000;
    RAM[0xfd25] = 0x000b0000;
    RAM[0xfd2a] = 0x000b0000;
    RAM[0xfd2f] = 0x000b0000;
    RAM[0xfd34] = 0x000b0000;
    RAM[0xfd39] = 0x000b0000;
    RAM[0xfd3e] = 0x000b0000;
    RAM[0xfd43] = 0x000b0000;
    RAM[0xfd48] = 0x000b0000;
    RAM[0xfd4d] = 0x000b0000;
    RAM[0xfd52] = 0x000b0000;
    RAM[0xfd57] = 0x000b0000;
    RAM[0xfd5c] = 0x000b0000;
    RAM[0xfd61] = 0x000b0000;
    RAM[0xfd66] = 0x000b0000;
    RAM[0xfd6b] = 0x000b0000;
    RAM[0xfd70] = 0x000b0000;
    RAM[0xfd75] = 0x000b0000;
    RAM[0xfd7a] = 0x000b0000;
    RAM[0xfd7f] = 0x000b0000;
    RAM[0xfd84] = 0x000b0000;
    RAM[0xfd89] = 0x000b0000;
    RAM[0xfd8e] = 0x000b0000;
    RAM[0xfd93] = 0x000b0000;
    RAM[0xfd98] = 0x000b0000;
    RAM[0xfd9d] = 0x000b0000;
    RAM[0xfda2] = 0x000b0000;
    RAM[0xfda7] = 0x000b0000;
    RAM[0xfdac] = 0x000b0000;
    RAM[0xfdb1] = 0x000b0000;
    RAM[0xfdb6] = 0x000b0000;
    RAM[0xfdbb] = 0x000b0000;
    RAM[0xfdc0] = 0x000b0000;
    RAM[0xfdc5] = 0x000b0000;
    RAM[0xfdca] = 0x000b0000;
    RAM[0xfdcf] = 0x000b0000;
    RAM[0xfdd4] = 0x000b0000;
    RAM[0xfdd9] = 0x000b0000;
    RAM[0xfdde] = 0x000b0000;
    RAM[0xfde3] = 0x000b0000;
    RAM[0xfde8] = 0x000b0000;
    RAM[0xfded] = 0x000b0000;
    RAM[0xfdf2] = 0x000b0000;
    RAM[0xfdf7] = 0x000b0000;
    RAM[0xfdfc] = 0x000b0000;
    RAM[0xfe01] = 0x000b0000;
    RAM[0xfe06] = 0x000b0000;
    RAM[0xfe0b] = 0x000b0000;
    RAM[0xfe10] = 0x000b0000;
    RAM[0xfe15] = 0x000b0000;
    RAM[0xfe1a] = 0x000b0000;
    RAM[0xfe1f] = 0x000b0000;
    RAM[0xfe24] = 0x000b0000;
    RAM[0xfe29] = 0x000b0000;
    RAM[0xfe2e] = 0x000b0000;
    RAM[0xfe33] = 0x000b0000;
    RAM[0xfe38] = 0x000b0000;
    RAM[0xfe3d] = 0x000b0000;
    RAM[0xfe42] = 0x000b0000;
    RAM[0xfe47] = 0x000b0000;
    RAM[0xfe4c] = 0x000b0000;
    RAM[0xfe51] = 0x000b0000;
    RAM[0xfe56] = 0x000b0000;
    RAM[0xfe5b] = 0x000b0000;
    RAM[0xfe60] = 0x000b0000;
    RAM[0xfe65] = 0x000b0000;
    RAM[0xfe6a] = 0x000b0000;
    RAM[0xfe6f] = 0x000b0000;
    RAM[0xfe74] = 0x000b0000;
    RAM[0xfe79] = 0x000b0000;
    RAM[0xfe7e] = 0x000b0000;
    RAM[0xfe83] = 0x000b0000;
    RAM[0xfe88] = 0x000b0000;
    RAM[0xfe8d] = 0x000b0000;
    RAM[0xfe92] = 0x000b0000;
    RAM[0xfe97] = 0x000b0000;
    RAM[0xfe9c] = 0x000b0000;
    RAM[0xfea1] = 0x000b0000;
    RAM[0xfea6] = 0x000b0000;
    RAM[0xfeab] = 0x000b0000;
    RAM[0xfeb0] = 0x000b0000;
    RAM[0xfeb5] = 0x000b0000;
    RAM[0xfeba] = 0x000b0000;
    RAM[0xfebf] = 0x000b0000;
    RAM[0xfec4] = 0x000b0000;
    RAM[0xfec9] = 0x000b0000;
    RAM[0xfece] = 0x000b0000;
    RAM[0xfed3] = 0x000b0000;
    RAM[0xfed8] = 0x000b0000;
    RAM[0xfedd] = 0x000b0000;
    RAM[0xfee2] = 0x000b0000;
    RAM[0xfee7] = 0x000b0000;
    RAM[0xfeec] = 0x000b0000;
    RAM[0xfef1] = 0x000b0000;
    RAM[0xfef6] = 0x000b0000;
    RAM[0xfefb] = 0x000b0000;
    RAM[0xff00] = 0x000b0000;
    RAM[0xff05] = 0x000b0000;
    RAM[0xff0a] = 0x000b0000;
    RAM[0xff0f] = 0x000b0000;
    RAM[0xff14] = 0x000b0000;
    RAM[0xff19] = 0x000b0000;
    RAM[0xff1e] = 0x000b0000;
    RAM[0xff23] = 0x000b0000;
    RAM[0xff28] = 0x000b0000;
    RAM[0xff2d] = 0x000b0000;
    RAM[0xff32] = 0x000b0000;
    RAM[0xff37] = 0x000b0000;
    RAM[0xff3c] = 0x000b0000;
    RAM[0xff41] = 0x000b0000;
    RAM[0xff46] = 0x000b0000;
    RAM[0xff4b] = 0x000b0000;
    RAM[0xff50] = 0x000b0000;
    RAM[0xff55] = 0x000b0000;
    RAM[0xff5a] = 0x000b0000;
    RAM[0xff5f] = 0x000b0000;
    RAM[0xff64] = 0x000b0000;
    RAM[0xff69] = 0x000b0000;
    RAM[0xff6e] = 0x000b0000;
    RAM[0xff73] = 0x000b0000;
    RAM[0xff78] = 0x000b0000;
    RAM[0xff7d] = 0x000b0000;
    RAM[0xff82] = 0x000b0000;
    RAM[0xff87] = 0x000b0000;
    RAM[0xff8c] = 0x000b0000;
    RAM[0xff91] = 0x000b0000;
    RAM[0xff96] = 0x000b0000;
    RAM[0xff9b] = 0x000b0000;
    RAM[0xffa0] = 0x000b0000;
    RAM[0xffa5] = 0x000b0000;
    RAM[0xffaa] = 0x000b0000;
    RAM[0xffaf] = 0x000b0000;
    RAM[0xffb4] = 0x000b0000;
    RAM[0xffb9] = 0x000b0000;
    RAM[0xffbe] = 0x000b0000;
    RAM[0xffc3] = 0x000b0000;
    RAM[0xffc4] = 0x000b0000;
    RAM[0xffc8] = 0x000b0000;
    RAM[0xffcd] = 0x000b0000;
    RAM[0xffd2] = 0x000b0000;
    RAM[0xffd7] = 0x000b0000;
    RAM[0xffdc] = 0x000b0000;
    RAM[0xffe1] = 0x000b0000;
    RAM[0xffe6] = 0x000b0000;
    RAM[0xffeb] = 0x000b0000;
    RAM[0xfff0] = 0x000b0000;
    RAM[0xfff5] = 0x000b0000;
    RAM[0xfffa] = 0x000b0000;
    RAM[0xffff] = 0x000b0000;
