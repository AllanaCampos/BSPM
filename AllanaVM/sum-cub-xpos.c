...
int main(){
    ...
    RAM[ 0xe] = 0x00020006;           RAM[ 0xf] = 0x00000001;       //LOAD
    RAM[0x10] = 0x00020005;           RAM[0x11] = 0x00000001;       //LOAD
    RAM[0x12] = 0x00020000;           RAM[0x13] = a;                //RAM[ 0xe]: LOAD  0e 01   // REG[0x0e] <- 0x0001 // Parametros
    RAM[0x14] = 0x000b000f;           RAM[0x15] = 0x00000034;       //JUMP
    RAM[0x16] = 0x0005000f;           RAM[0x17] = 0x000f0005;       //ADD
    RAM[0x18] = 0x00040000;           RAM[0x19] = 0x000f000e;       //MOVE
    RAM[0x1a] = 0x00020000;           RAM[0x1b] = 0x00000022;       //RAM[0xee94]: LOAD  00 28    // REG[0x00] <- 28
    RAM[0x1c] = 0x00030000;           RAM[0x1d] = 0x0000fc07;       //RAM[0xee96]: STORE 00 fc07  // RAM[0xfc07] <- REG[0x00]
    RAM[0x1e] = 0x000200fd;           RAM[0x1f] = 0x00000024;       //RAM[0xee98]: LOAD  fd 2a    // REG[0xfd] <- 2a
    RAM[0x20] = 0x000b0000;           RAM[0x21] = 0x0000fbea;       //RAM[0xee9a]: JUMP  00 fbea  // if (REG[0x00] == REG[0x00]) {p <- 0xfbea;} // LIT
    RAM[0x22] = 0x000b0000;           RAM[0x23] = 0x0000ef8e;       //RAM[0xee9c]: JUMP  00 ef8e  // if (REG[0x00] == REG[0x00]) {p <- 0xef8e;} // MULT
    RAM[0x24] = 0x00040000;           RAM[0x25] = 0x0004000e;       //MOVE
    RAM[0x26] = 0x00020000;           RAM[0x27] = 0x0000002e;       //RAM[0xee94]: LOAD  00 28    // REG[0x00] <- 28
    RAM[0x28] = 0x00030000;           RAM[0x29] = 0x0000fc07;       //RAM[0xee96]: STORE 00 fc07  // RAM[0xfc07] <- REG[0x00]
    RAM[0x2a] = 0x000200fd;           RAM[0x2b] = 0x00000030;       //RAM[0xee98]: LOAD  fd 2a    // REG[0xfd] <- 2a
    RAM[0x2c] = 0x000b0000;           RAM[0x2d] = 0x0000fbea;       //RAM[0xee9a]: JUMP  00 fbea  // if (REG[0x00] == REG[0x00]) {p <- 0xfbea;} // LIT
    RAM[0x2e] = 0x000b0000;           RAM[0x2f] = 0x0000ef8e;       //RAM[0xee9c]: JUMP  00 ef8e  // if (REG[0x00] == REG[0x00]) {p <- 0xef8e;} // MULT
    RAM[0x30] = 0x00050006;           RAM[0x31] = 0x00060004;       //ADD
    RAM[0x32] = 0x000b0000;           RAM[0x33] = 0x00000012;       //JUMP
    RAM[0x34] = 0x00040000;           RAM[0x35] = 0x00060004;       //MOVE
    RAM[0x36] = 0x000c0000;           RAM[0x37] = 0x00000000;       //RAM[0x1a]: HALT  00 00   // END
