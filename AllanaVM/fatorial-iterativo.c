...
int main(){
    ...
    RAM[0x10] = 0x00020005;           RAM[0x11] = 0xffffffff;       //LOAD
    RAM[0x12] = 0x00020000;           RAM[0x13] = 0x00000001;       //RAM[ 0xe]: LOAD  0e 01   // REG[0x0e] <- 0x0001 // Parametros
    RAM[0x14] = 0x000b000f;           RAM[0x15] = 0x00000026;       //JUMP
    RAM[0x16] = 0x0005000f;           RAM[0x17] = 0x000f0005;       //ADD
    RAM[0x18] = 0x00040000;           RAM[0x19] = 0x0004000e;       //MOVE
    ...
    RAM[0x24] = 0x000b0000;           RAM[0x25] = 0x00000012;       //JUMP
    RAM[0x26] = 0x000c0000;           RAM[0x27] = 0x00000000;       //RAM[0x1a]: HALT  00 00   // END
