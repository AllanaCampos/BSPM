...
int main(){
	...
	code[18].f = 1;     code[18].l = 0;     code[18].a = 2;     //OPR 0 2 // OPR 0 ADD
	code[19].f = 3;     code[19].l = 0;     code[19].a = 4;     //STO 0 4
	code[20].f = 6;     code[20].l = 0;     code[20].a = 5;     //JMP 0 5
	code[21].f = 1;     code[21].l = 0;     code[21].a = 0;     //OPR 0 0 
	//END 0 0
